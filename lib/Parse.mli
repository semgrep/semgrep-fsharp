...
(**
    Functions for parsing fsharp programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a fsharp program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.file, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a fsharp program from a file into a typed OCaml CST.
